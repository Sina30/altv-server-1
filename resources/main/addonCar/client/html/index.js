...
function drawSpeedo(speed, gear, rpm) {
	if (speed == undefined) {
		...
		speed = Math.floor(speed * 3.6); // to km/h
		rpm = rpm * 10;
	}
	...
	for (var i = 10; i <= Math.ceil(topSpeed / 20) * 20; i += 10) {
		console.log();
		drawMiniNeedle(calculateSpeedAngle(i / topSpeed, 83.07888, 34.3775) * Math.PI, i % 50 == 0 ? 3 : 1, i % 50 == 0 ? i : '');
