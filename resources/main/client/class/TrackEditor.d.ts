...
export default class TrackEditor extends TrackBase {
    ...
    public insertCheckpoint(index: number, data: CheckpointData): number;
    public addCheckpoint(data: CheckpointData): number;
    ...
    public changeCheckpointRadius(index: number, radius: number);
